    ...
    <EpisodeWrapper episode={7}>
      ...
      >
        <p>
          ...
          zbavovali a&nbsp;nahradzovali svoje vybavenie za 16-bitové mašiny. Aj
          na našom území, tí šťastnejší, ktorým sa v&nbsp;minulosti podarilo
          dostať k&nbsp;8-bitovým počítačom a&nbsp;v&nbsp;90. rokoch mali
          finančné možnosti, sa 8-bitov takisto postupne zbavovali
          a&nbsp;prechádzali na Amigy, STčká alebo PC. V&nbsp;krajinách bývalého
          východného bloku tak začali tieto malé zázraky ožívať v&nbsp;rukách
          nových používateľov, ktorí na nich začali tvoriť nové a&nbsp;nové
          veci.
        </p>
      </FigureImage>
      ...
      <p>
        Ako rád hovorí môj dobrý a&nbsp;veľmi vážený priateľ <b>Slavo Labský</b>{' '}
        alias <b>Busy</b> (ktorý stál v&nbsp;prvej línii tejto obrody
        ZX&nbsp;Spectra na prelome 80. a&nbsp;90. rokov), že oni k&nbsp;tomu
        ZX&nbsp;Spectru prišli a&nbsp;nikto im nepovedal, že sa{' '}
        <i>&bdquo;niečo nedá&rdquo;</i>. A&nbsp;tak skrátka prelamovali hranice
        toho, čo bolo dovtedy považované za možné a&nbsp;prekonávali dovtedy
        videné.
      </p>
      ...
      >
        <p>
          ...
          AY-3-8912 inšpirovaný Amigáckymi trackermi. Možno ani on sám netušil,
          čo tým odštartuje.
        </p>
        <FigureAudio
      ...
      >
        ...
        <p className='mt-5'>
          Keď nástroj s&nbsp;glissandom nadol predĺžime a&nbsp;necháme šumieť po
          celý čas, ale pridáme postupné stišovanie, pričom znižujeme frekvenciu
          šumu, získame zvuk pripomínajúci <b>malý bubon</b> (ľudovo{' '}
          <i>&bdquo;rytmičák&rdquo;</i>).
        </p>
        <FigureAudio
      ...
      <p className='clear-both'>
        ...
        Predstavte si rozložený akord, napríklad durový, ktorý má intervaly 0, 4
        a&nbsp;7 poltónov od základného tónu (teda napríklad C, E, G, čiže
      ...
      <Heading id='zrod-8-bitovej-demosceny'>Zrod 8-bitovej demoscény</Heading>
      <p>
        ...
        vlastných prehravacích rutinách, v&nbsp;dátach, priamo v&nbsp;strojovom
        kóde&hellip;
      </p>
      <p>
        A zrazu tu bol používateľsky príjemný hudobný softvér, ktorý ovládol
        každý, kto mal aspoň aké-také hudobné základy a&nbsp;tracker mu nakoniec
        vytvoril kompilát aj s&nbsp;hradlom, ktoré stačilo vložiť do svojho dema
        či hry. Začali sa preto na demoscéne bývalého východného bloku rojiť
        nové demomakerské skupiny, ktoré vydávali nové a&nbsp;nové demá, ale už
        tu bolo niečo inak: Obsahovali totiž autorskú, pôvodnú hudbu.
      </p>
      ...
      <p>
        ...
        či Pentagram &ndash; a&nbsp;tieto skupiny spája meno jedného hudobníka,
        ktorý navždy poznačil hudobný katalóg ZX&nbsp;Spectra a&nbsp;zadefinoval
        úplne nový zvuk tejto doby.
      </p>
      <FigureAudio
      ...
      >
        <p>
          To meno je <b>Ed Polinski</b> alias <b>Agent-X</b>, ktorý začal chŕliť
          svoje jazz-rockovo ladené skladby, plné originality, s&nbsp;hutnou
          basovou linkou, a&nbsp;kreatívne využívajúc dovtedy neprebádanú
          vlastnosť čipu AY: <b>hardvérové obálky</b>.
        </p>
      </FigureAudio>
      ...
      >
        <p>
          Ďalším známym hudobníkom z&nbsp;poľskej scény bol <b>Andrzej Siuda</b>{' '}
          alias <b>Ziutek</b>, ktorý pôsobil v&nbsp;skupine ESI. Jeho tvorba je
          zložená prevažne s&nbsp;prerábok známych piesní, často komerčných
          hitov, ale vždy veľmi kreatívne a&nbsp;s&nbsp;vlastným originálnym
          štýlom&hellip;
        </p>
      </FigureAudio>
      <p>
      ...
      <p>
        ...
        v&nbsp;Československu zlatá éra ZX&nbsp;Spectra &ndash; s&nbsp;množstvom
        nových hier, diem a&nbsp;časopisov, ktoré sa mu venovali&hellip; no
        a&nbsp;samozrejme hudobníkov! Tých najvýznamnejších vám teraz
        predstavím:
      </p>
      ...
      <p>
        ...
        nikdy nepotreboval. Už koncom 80. rokov si totiž napísal vlastnú hudobnú
        rutinu Amadeus, v&nbsp;ktorej v&nbsp;dátach napísal desiatky
      ...
      >
        <p>
          ...
          <b>George K.</b> práve na základe podnetov a&nbsp;nápadov týchto dvoch
          hudobníkov. Prišiel s&nbsp;novou koncepciou tvorby skladieb, kedy
          hudobné dáta pre každý kanál upravujete zvlášť a&nbsp;môžete ich
          znovu-použiť kdekoľvek v&nbsp;rámci celej skladby. Vizuálne vylepšil
          a&nbsp;sprehľadnil editáciu nástrojov či ornamentov a&nbsp;pridal aj
          hromadné operácie, ako kopírovanie a&nbsp;nahrádzanie dát
          v&nbsp;patternoch.
        </p>
        <p>
      ...
      >
        <p>
          Svoju hudobnú kariéru na ZX&nbsp;Spectre začal práve na SQ-Trackeri aj{' '}
          <b>Vít Hotárek</b> alias <b>X-Agon</b>, ktorý bol schopný v&nbsp;90.
          rokoch vytvoriť možno aj stovku skladieb a&nbsp;tvorcovia diem po nich
          často siahali. Čo ma ale veľmi teší je to, že na tvorbu
          a&nbsp;ZX&nbsp;Spectrum nezanevrel a&nbsp;každoročne nám na demopárty
          prináša stále lepšie nové skladby.
        </p>
        <p>
      ...
      >
        <p>
          ...
          najoceňovanejších scénerov na svete. Navyše mi pomáha aj s&nbsp;týmto
          podcastom, lebo je proof-readerkou celej tejto série
      ...
      >
        <p>
          ...
          hudobnú rutinu sa celé tie roky stará a&nbsp;vylepšuje. Norova tvorba
          je silne inšpirovaná jeho zbožňovaným Jeanom Michelom Jarrem a&nbsp;má
          unikátny zvuk, čiže jeho skladby znejú úplne inak ako ostatné
          &bdquo;aypsilonkoviny&rdquo;.
        </p>
      </FigureAudio>
      ...
      >
        <p>
          ...
          <b>Zsolt Trencsenyi</b> alias <b>Tren</b> fungoval ako dvorný muzikant
          košickej demogrupy <b>7Gods</b>. Táto skupina hviezdila na slovenskej
          demoscéne v&nbsp;90. rokoch.
        </p>
        <p>
          Pamätáte si, ako sme si v&nbsp;
          <EpisodeLink episode={5}>5. epizóde</EpisodeLink> púšťali fantastický
          Amiga mod Space Debris? Tak táto ukážka je Trenova
      ...
      >
        <p>
          ...
          Jeho meno tiež môžete zahliadnuť v&nbsp;titulkoch súčasných moderných
          hier. Tento rodák z&nbsp;Dubnice je však všestranne talentovaný
          a&nbsp;jeho hudobná tvorba na ZX&nbsp;Spectrum je špecificky tvrdá,
          minimalistická, väčšinou v&nbsp;techno štýle.
        </p>
        <p>
      ...
      >
        ...
        >
          <p>
            No a&nbsp;najlepšie na záver. Muzikant, ktorého vám teraz predstavím
            je známy skladbami s&nbsp;výraznou swingujúcou rytmikou, silnými
            melodickými linkami a&nbsp;výborne budovanou atmosférou.{' '}
            <b>Branislav Bekeš</b> alias <b>z00m</b> sa okrem tvorby hudby
            venuje aj hardvéru starých počítačov, má o&nbsp;ňom skvelý prehľad
            a&nbsp;venuje sa oživovaniu a&nbsp;opravám týchto pokladov
            v&nbsp;združení{' '}
      ...
      <p>
        Dnes to bola epizóda opäť veľmi bohatá na ukážky. Asi tuším, že ľudia so
        scény mi určite budú vyčítať, že som nespomenul toho, či onoho
